...
public abstract class PlayDateWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static PlayDateWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(PlayDateWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<PlayDateDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<PlayDateDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<PlayDateDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<PlayDateDbContext, Task<T>> func)
    {
        T result;
